  ...
  function rebalance(marked_colors){
    ...
    $.get("/v1/rebalance", function(data, status){
      ...
      for (var i=0;i<marked_tags.length;i++){
        ...
        document.getElementById(marked_tags[i].hashCode()).style.backgroundColor = marked_colors[0];
      }}
      ...
      for (var i=0;i<marked_goals.length;i++){
        ...
        document.getElementById(marked_goals[i].hashCode()).style.backgroundColor =  marked_colors[1];
      }
      ...
      for (var i=0;i<marked_review.length;i++){
        ...
        document.getElementById(lowercase(marked_review[i]).hashCode()).style.backgroundColor =  marked_colors[2];
        }
